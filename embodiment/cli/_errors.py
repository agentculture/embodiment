...
Every failure inside embodiment raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`embodiment.cli._output`,
...
# Exit-code policy. Documented in ``embodiment learn`` output.
# 0      = success
