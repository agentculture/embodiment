...
from embodiment.cli._errors import EXIT_USER_ERROR, CliError
from embodiment.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/embodiment/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = _CliArgumentParser(
        prog="embodiment",
        description="embodiment — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
