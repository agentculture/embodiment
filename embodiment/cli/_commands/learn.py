"""``embodiment learn`` — the learnability affordance.
...
_TEXT = """\
embodiment — a clonable template for AgentCulture mesh agents.
...
--------
  ...
  embodiment learn              This self-teaching prompt.
  embodiment explain <path>...  Markdown docs for any noun/verb path.
  embodiment overview           Descriptive snapshot of the agent.
  embodiment doctor             Check the agent-identity invariants.
  embodiment cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "embodiment explain <path>",
    }
