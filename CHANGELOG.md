...
- Stage-1 live results (`docs/live-test-results/scopebench.md`): `INCONCLUSIVE` under the committed rule, with every condition reported separately and every absent cell explained. The pre-registration gained an amendments section recording all three departures `t11` made
